...
try {
    ...
    foreach ($orders as $order) {
        ...
        $formattedOrders[] = [
            ...
            'phone' => $order['phone'],
            'created_at'   => !empty($order['created_at'])   ? (new DateTime($order['created_at'],   new DateTimeZone('Asia/Dhaka')))->format('c') : null,
            'confirmed_at' => !empty($order['confirmed_at']) ? (new DateTime($order['confirmed_at'], new DateTimeZone('Asia/Dhaka')))->format('c') : null,
            'prepared_at'  => !empty($order['prepared_at'])  ? (new DateTime($order['prepared_at'],  new DateTimeZone('Asia/Dhaka')))->format('c') : null,
